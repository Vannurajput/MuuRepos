...
// FIX: Add FoldableRegion type definition for code folding functionality.
...
export interface LanguageSupport {
  ...
  // FIX: Add optional getFoldableRegions to support code folding.
...
// FIX: Add AutocompleteState type definition for the autocomplete component.
...
// FIX: Add InlineSuggestionState type definition for inline code suggestions.
...
declare global {
  interface Window {
    ...
    prettier: any;
    prettierPlugins: any;
    // FIX: Property names with special characters like '-' or '.' must be quoted.
    'sql-wasm.js': any;
    initSqlJs: any;
    duckdb: any;
  }
